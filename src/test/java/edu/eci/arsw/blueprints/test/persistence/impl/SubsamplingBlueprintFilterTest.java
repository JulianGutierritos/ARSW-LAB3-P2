...
public class SubsamplingBlueprintFilterTest {
	...
	@Test
    public void eliminaPuntosEnLaMismaRecta() throws BlueprintPersistenceException, BlueprintNotFoundException{
		...
		assertEquals(bps.getPoints().size(),10);
    }
	
	@Test
    public void noEliminaPuntosRepetidos() throws BlueprintPersistenceException, BlueprintNotFoundException{
		ApplicationContext ac = new ClassPathXmlApplicationContext("applicationContext2.xml");
		BlueprintsServices bps = ac.getBean(BlueprintsServices.class);
		Point a=new Point(3,2);
